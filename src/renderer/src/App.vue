...
<template>
  <div class="app-shell" :class="{ 'is-macos': isMacOS }">
    <AppTaskbar :server-icon-text="activeServer?.iconText ?? 'OC'" :server-name="activeServer?.displayName ?? 'OpenChat Client'" />
    ...
    <section class="layout" :class="{ 'is-members-collapsed': !appUI.membersPaneOpen }">
      ...
      <WorkspaceToolbar
        ...
        :server-name="activeServer?.displayName ?? 'Unknown Server'"
        :members-pane-open="appUI.membersPaneOpen"
        @toggle-members-pane="toggleMembersPane"
      />
    ...
    <AddServerDialog
      :is-open="isAddServerDialogOpen"
      :backend-url="addServerForm.backendUrl"
      :server-id="addServerForm.serverId"
      :display-name="addServerForm.displayName"
      :error-message="addServerForm.errorMessage"
      :is-submitting="addServerForm.isSubmitting"
      @close="closeAddServerDialog"
      @discover="discoverServersFromURL"
      @add-manually="addServerManually"
      @update:backend-url="addServerForm.backendUrl = $event"
      @update:server-id="addServerForm.serverId = $event"
      @update:display-name="addServerForm.displayName = $event"
    />
  </div>
</template>
